		...
		<header>
			<div class="center">
				...
				if(isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] && isset($_SESSION['user']))
					echo /*'<a href="./search"><input type="button" value="Tat suchen" style="font-size: 10px; margin-top: -20px;" /></a><br><br>*/'<a href="./profile">' . $_SESSION['user'] . '</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="./logout">' . 'Logout' . '</a>';
				else
