	...
	<div class="wrap">
		<header>
			<div class="center">
				...
				<?php
				if($_USER->loggedIn())
					echo '<a href="./search"><input type="button" value="suchen" style="font-size: 10px; margin-top: -20px;" /></a><br><br><a href="./profile">' . $_USER->getUsername() . '</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="./logout">' . 'Logout' . '</a>';
				else
