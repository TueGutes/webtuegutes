...
//		$blAdresse .= '<td style="border:none"><input type="text" name="txtOrt" placeholder="Ort" value="' . (($thisuser['postalcode']!=0)?$thisuser['place']:'') . '"></td></tr>';
		...
		$blPrivacy .= '<tr>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsFirstname" value="1" '.(substr($thisuser['privacykey'],5,1)?'checked="checked"':'').' ><label> Meinen Vornamen</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsLastname" value="1" '.(substr($thisuser['privacykey'],6,1)?'checked="checked"':'').' ><label> Meinen Nachnamen</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsGender" value="1" '.(substr($thisuser['privacykey'],7,1)?'checked="checked"':'').' ><label> Mein Geschlecht</label></td>';
		$blPrivacy .= '</tr>';

		$blPrivacy .= '<tr>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsBirthday" value="1" '.(substr($thisuser['privacykey'],13,1)?'checked="checked"':'').' ><label> Meinen Geburtstag</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsBirthyear" value="1" '.(substr($thisuser['privacykey'],14,1)?'checked="checked"':'').' ><label> Mein Geburtsjahr</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsMail" value="1" '.(substr($thisuser['privacykey'],0,1)?'checked="checked"':'').' ><label> Meine E-Mail Adresse</label></td>';
		$blPrivacy .= '</tr>';

		$blPrivacy .= '<tr><th colspan="3" style="border:none;text-align:center"><br><b>Adresse</b></th></tr>';
		$blPrivacy .= '<tr>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsStreet" value="1" '.(substr($thisuser['privacykey'],8,1)?'checked="checked"':'').' ><label> Meine Straße</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsHousenumber" value="1" '.(substr($thisuser['privacykey'],9,1)?'checked="checked"':'').' ><label> Meine Hausnummer</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsPlzOrt" value="1" '.(substr($thisuser['privacykey'],10,1)?'checked="checked"':'').' ><label> Meinen Wohnort</label></td>';
		$blPrivacy .= '</tr>';

		$blPrivacy .= '<tr><th colspan="3" style="border:none;text-align:center"><br><b>Über Dich</b></th></tr>';
		$blPrivacy .= '<tr>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsAvatar" value="1" '.(substr($thisuser['privacykey'],2,1)?'checked="checked"':'').' ><label> Mein Profilbild</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsHobbys" value="1" '.(substr($thisuser['privacykey'],3,1)?'checked="checked"':'').' ><label> Meine Hobbys</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsDescription" value="1" '.(substr($thisuser['privacykey'],4,1)?'checked="checked"':'').' ><label> Meine Beschreibung von mir selbst</label></td>';
		$blPrivacy .= '</tr>';

		$blPrivacy .= '<tr><th colspan="3" style="border:none;text-align:center"><br><b>Sonstiges</b></th></tr>';
		$blPrivacy .= '<tr>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsTelNr" value="1" '.(substr($thisuser['privacykey'],11,1)?'checked="checked"':'').' ><label> Meine Telefonnummer</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsMsgNr" value="1" '.(substr($thisuser['privacykey'],12,1)?'checked="checked"':'').' ><label> Meine Messengernummer</label></td>';
		$blPrivacy .= '<td style="border:none;padding:10px"><input type="checkbox" name="vsRegDate" value="1" '.(substr($thisuser['privacykey'],1,1)?'checked="checked"':'').' ><label> Datum meiner Registrierung</label></td>';
		$blPrivacy .= '</tr>';

		$blPrivacy .= "</table><br><br><hr><br>";

		$form_bottom = '<br><input type=submit value="Änderungen speichern"><input type="hidden" name="action" value="save"></form><br><hr><br>';
