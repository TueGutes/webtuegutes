...
-- -----------------------------------------------------
-- Table `tuegutesdb`.`Status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tuegutesdb`.`Status` ;

CREATE TABLE IF NOT EXISTS `tuegutesdb`.`Status` (
  `idStatus` INT NOT NULL,
  `Statusbezeichnung` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tuegutesdb`.`Benutzer` (
  ...
  INDEX `fk_Benutzer_Status1_idx` (`idStatus` ASC),
  ...
  CONSTRAINT `fk_Benutzer_Benutzergruppe1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Benutzer_Status1`
    FOREIGN KEY (`idStatus`)
    REFERENCES `tuegutesdb`.`Status` (`idStatus`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `tuegutesdb`.`Taten` (
  ...
  INDEX `fk_Taten_Status1_idx` (`idStatus` ASC),
