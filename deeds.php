...
<br> 
		...
		<?php
			...
			*/
			...
			$arr = db_getGuteTatenForList($tatenProSeite*($_GET['page']-1), $tatenProSeite);
...
<?php
	$vor = $_GET['page'] > 1;
	$nach = db_getGuteTatenForList($tatenProSeite*($_GET['page']), $tatenProSeite); //Sobald Deeds nicht mehr doppelt ausgegeben werden -> Mit Anzahl prüfen!
